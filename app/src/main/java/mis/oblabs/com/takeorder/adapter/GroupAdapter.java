...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.Holder> {
    ...
    GroupFragment.StateCallback dismissCallback;

    public GroupAdapter(List<ObjGroup> list ) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        final ObjGroup data= list.get(position);

        holder.itemView.setTag(data.getGroupID());
    ...
    public void setDismissCallback(GroupFragment.StateCallback callback) {
